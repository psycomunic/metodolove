...
import { Horizonte, LinhasReveal } from "./movimento";
...
export default function Oferta() {
  return (
    <section
      id="oferta"
      className="grao relative isolate overflow-hidden bg-mar-900 pt-24 pb-28 text-areia-100 sm:pt-32"
    >
      <div className="absolute inset-0 z-0 bg-[radial-gradient(110%_72%_at_18%_-4%,#0E5180_0%,#062A45_46%,#04192B_100%)]" />
      <Horizonte className="absolute inset-x-0 bottom-0 z-0 h-44 w-full opacity-80 lg:h-60" />
      ...
      <div className="relative z-10 mx-auto max-w-[80rem] px-5 sm:px-8">
        <div className="max-w-[34rem]">
          ...
          <h2 className="display mt-6 text-[clamp(2.3rem,7vw,3.8rem)] text-areia-50">
            <LinhasReveal
              linhas={[
                "Menos que um par",
        ...
        <Reveal atraso={160} className="mt-14">
          <div className="elevado mx-auto grid max-w-[64rem] overflow-hidden bg-areia-50 text-tinta lg:grid-cols-[1.02fr_0.98fr]">
            ...
            <div className="flex flex-col justify-center bg-areia-200/50 p-8 sm:p-11">
              {oferta.vagas ? (
              ...
              <p className="text-[0.82rem] font-semibold text-tinta/45">
                De{" "}
                <span className="line-through decoration-mar-600 decoration-2">
                  {oferta.precoCheio}
                </span>{" "}
                por
              </p>
        ...
        <Reveal atraso={110} className="mt-14">
          <div className="mx-auto flex max-w-[48rem] flex-col items-start gap-6 border-t border-mar-700/60 pt-10 sm:flex-row sm:gap-10">
