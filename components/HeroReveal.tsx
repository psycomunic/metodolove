...
export default function HeroReveal({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[linear-gradient(100deg,#060E3A_0%,rgba(6,14,58,0.93)_24%,rgba(6,14,58,0.62)_56%,rgba(6,14,58,0.42)_100%)]" />
      ...
      >
        ...
        <div className="absolute inset-0 bg-[linear-gradient(100deg,rgba(6,14,58,0.86)_0%,rgba(6,14,58,0.42)_38%,rgba(6,14,58,0.16)_100%)]" />
      </div>
    </div>
  );
}
