...
export default function CtaFinal() {
  return (
    <section className="escuro relative isolate overflow-hidden bg-void px-5 pt-20 pb-40 sm:px-8 sm:pt-32 sm:pb-56 lg:pt-40 lg:pb-64">
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 -z-10">
        <div
          className="absolute bottom-[-22%] left-1/2 h-[26rem] w-[30rem] -translate-x-1/2 rounded-full opacity-[0.3] sm:h-[44rem] sm:w-[68rem]"
          style={{
            background: "radial-gradient(ellipse, #E3B86A 0%, transparent 70%)",
            filter: "blur(140px)",
          }}
        />
        <div
