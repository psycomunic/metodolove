      ...
      <div className="mx-auto grid max-w-[80rem] gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20">
        <header className="lg:sticky lg:top-28 lg:self-start">
          ...
          <Manchete
            ...
            destaque="dúvida?"
            className="mt-6 text-[clamp(2.25rem,5.4vw,3.6rem)] text-ink"
          />
          <Reveal atraso={140}>
            <p className="mt-7 max-w-[26rem] text-[0.97rem] leading-[1.6] text-mute">
              {faqRemate}{" "}
              <a
                href={marca.instagram}
                target="_blank"
                rel="noopener noreferrer"
                className="font-semibold text-verde underline underline-offset-4 transition-colors hover:text-glow"
              >
            ...
            <Reveal key={item.p} atraso={i * 40}>
              <details className="group border-b border-line">
                <summary className="flex items-start justify-between gap-6 py-6 text-left">
                  <h3 className="text-[1rem] leading-snug font-semibold text-ink transition-colors group-hover:text-glow sm:text-[1.08rem]">
                    {item.p}
                  </h3>
                  <span
                    aria-hidden="true"
                    className="cruz mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-line text-mute transition-transform duration-300 group-hover:border-verde group-hover:text-verde"
                  >
                    <svg
                      viewBox="0 0 24 24"
                ...
                <p className="max-w-[42rem] pb-7 text-[0.95rem] leading-[1.65] text-mute">
                  {item.r}
                </p>
              </details>
            </Reveal>
