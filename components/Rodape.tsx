...
export default function Rodape() {
  ...
  return (
    <footer className="border-t border-mar-800 bg-mar-950 px-5 pt-16 pb-28 text-areia-200/60 sm:px-8 sm:pb-16">
      <div className="mx-auto max-w-[80rem]">
        <div className="flex flex-col gap-10 border-b border-mar-800 pb-10 md:flex-row md:items-start md:justify-between">
          <div>
        ...
        <div className="mt-8 space-y-4 text-[0.74rem] leading-relaxed text-areia-200/40">
          ...
          <div className="flex flex-col gap-2 border-t border-mar-800/70 pt-6 sm:flex-row sm:items-center sm:justify-between">
            <p>
